...
function testSubcategoryProjectorAndScreenList(testname){
...
testSubcategoryProjectorAndScreenList("Sub_CategoryProjectorAndScreenList_Test");
...
testProjectorAndScreen_CheckPDP_PageProductDetails("Verify Projector And ScreenList PDP page product Details_Test");
testSearchProducts("Searching the ProjectorAndScreenList Product from Search Field_Test");
